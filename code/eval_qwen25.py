...
def submit_vqa_to_qwen(model, tokenizer, qa):
...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLM.from_pretrained(
        model_name, torch_dtype="auto", device_map="auto", cache_dir="/ibex/project/c2191/wenxuan_proj/huggingface_model_weight"
    )
    ...
    for dataset_name in dataset_names:
        ...
        for key in dataset_qa_data_keys:
            ...
            answer = submit_vqa_to_qwen(model, tokenizer, str(unique_qa_data))
