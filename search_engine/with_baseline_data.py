...
def submit_vqa_to_llm(client, qa, retrieved_knowledge=None):
    ...
    print(f"Completion result: {completion.choices[0].message.content}")
...
if __name__ == "__main__":
    save_path = f"./results/with_baseline_data"  # Changed the path to reflect KG-RAG approach
    ...
    engine_data_file_path = "/home/plusai/Documents/github/LightRAG/cs394/search_results_baseline.json"
